...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    ...
    <style>
        ...
        *,
        ...
        .form-select:focus {
            ...
            .was-validated .form-select:valid{border-color:var(--bs-form-valid-border-color)}.form-select.is-valid:not([multiple]):not([size]),.form-select.is-valid:not([multiple])[size="1"],
            ...
            .was-validated .form-select:invalid{border-color:var(--bs-form-invalid-border-color)}.form-select.is-invalid:not([multiple]):not([size]),.form-select.is-invalid:not([multiple])[size="1"],
    ...
    <style>
                /* Esta es una forma temporal de delcarar las variables de bootstrap */

        :root {
            --bs-primary: #BD6DFF; /* Nuevo color primario */
            --bs-primary-fuerte: #7929bb; /* esto se debe borrar */
            --bs-primary-rgb: 189, 109, 255;
            --link-color: var(--bs-primary); /* Color de los enlaces */
            --bs-btn-color: #ffffff; /* Color del texto del botón */
            --bs-btn-border-color2: var(--bs-primary-fuerte); /* Color del borde del botón */
            --bs-border-color2:222, 226, 230;
            --bs-link-color-rgb:33,37,41;
            --bs-btn-hover-bg2:var(--bs-primary-fuerte);
            --bs-btn-hover-border-color:var(--bs-primary-fuerte);
            --bs-btn-active-bg:var(--bs-primary-fuerte);
            --bs-btn-active-border-color2:var(--bs-primary-fuerte);
            --body-bg-color-rgb:rgb(253, 253, 255);
            --body-bg-color-rgb:rgb(253, 253, 255);
            --bs-primary-bg-subtle: #efdcff;
            --bs-btn-active-color: #ffffff;
            --bs-btn-hover-bg: var(--bs-primary) !important;
            --bs-btn-hover-border-color: var(--bs-primary-fuerte) !important;
            --bs-btn-bg:#BD6DFF !important;
        }
        ...
        .btn-check:checked+.btn, .btn.active, .btn.show, .btn:first-child:active, :not(.btn-check)+.btn:active{
            background-color: var(--bs-primary-fuerte);
            border-color: var(--bs-btn-active-border-color2);
            color: white;
        }
        ...
        /* andres codigo para las etiquetas a del mismo color que el primary */
        .hiper-vinculo{
        ...
        /* outline para el mismo color de boton pero outline */
        .btn-outline-primary {
            color: #BD6DFF;
            border: 1px solid #BD6DFF;
            background-color: transparent;
    ...
    <style>
        ...
        .accounts-section {
            ...
            overflow-y: auto;
            overflow-x: hidden;
            /* Para evitar que se sobreponga el scroll */
        }
        ...
        /* RANDOM  Se debe corregir y ver si hay algo que no es global */
        a:hover, a.active {
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="min-vh-100 col-md-9 ms-sm-auto col-lg-10 px-md-4">
                @yield('content')
            </main>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (btnEnviarMensaje) {
                btnEnviarMensaje.addEventListener("click", () => {
                    ...
                    // Cerrar el modal
                    const enviarMensajeModal = bootstrap.Modal.getInstance(document.getElementById(
                        "enviarMensajeModal"))
