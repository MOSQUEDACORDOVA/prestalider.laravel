    ...
    <div class="form-header">
        <div class="header-content">
            <div class="title-section">
                ...
                <p class="form-subtitle">Modifica la información del usuario y sus roles</p>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="correo@ejemplo.com" value="{{ $user->email }}" required>
                    </div>
                    ...
                    <div class="roles-grid">
                        ...
                        <div class="role-item">
                            <label class="role-checkbox">
                                <input type="checkbox" name="roles[]" value="{{ $id }}" {{ in_array($id, $userRole) ? 'checked' : '' }}>
