    ...
    <div class="form-header">
        <div class="header-content">
            <div class="title-section">
                <h2 class="form-title">Crear Nuevo Permiso</h2>
                <p class="form-subtitle">Crea un nuevo permiso para el sistema</p>
            </div>
                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="action" id="action" class="form-control" placeholder="Ej: list, create, edit, delete" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="3" placeholder="Descripción detallada del permiso"></textarea>
