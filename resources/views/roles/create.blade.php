    ...
    <div class="form-header">
        <div class="header-content">
            <div class="title-section">
                <h2 class="form-title">Crear Nuevo Rol</h2>
                <p class="form-subtitle">Crea un nuevo rol y asigna permisos específicos</p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    roleForm.addEventListener('submit', function(e) {
        ...
        if (checkedPermissions.length === 0) {
            if (!confirm('¿Está seguro de crear un rol sin permisos asignados?')) {
                e.preventDefault();
                return;
            }
        }
